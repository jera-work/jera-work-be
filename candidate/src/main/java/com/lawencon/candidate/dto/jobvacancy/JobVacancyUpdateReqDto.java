...
public class JobVacancyUpdateReqDto {
	...
	private String vacancyDescriptionId;
	...
	public String getVacancyDescriptionId() {
		return vacancyDescriptionId;
	}

	public void setVacancyDescriptionId(String vacancyDescriptionId) {
		this.vacancyDescriptionId = vacancyDescriptionId;
	}
